...
# TODO this is where I scramble word order
import random
for n in sequences:
    random.shuffle(n)
...
# TODO: here I temoved embeddings and added initializer.
...
# dense_finacal = get_output(model, 'dense_final', layer_2d_or_1d='1d', Xtest=X_encoded)
